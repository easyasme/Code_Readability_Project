...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        try:
            ...
            data = [["#", "Style Guide Adherence", "Variable Name Quality", "Complexity Score", "Max Line", "Comment Ratio"]]
            for root, dirs, files in os.walk("temp_dest"):
                ...
                for file in py_files:
                    if file.endswith(".py"):
                        ...
                        result = [id, adherence_score, var_name_score, complexity_score, max_line]
                        data.append(result)
